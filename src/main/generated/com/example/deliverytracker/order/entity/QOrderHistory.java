...
public class QOrderHistory extends EntityPathBase<OrderHistory> {
    ...
    private static final long serialVersionUID = -1574464586L;
    ...
    public final EnumPath<Order.Status> newStatus = createEnum("newStatus", Order.Status.class);

    public final QOrder order;

    public final EnumPath<Order.Status> previousStatus = createEnum("previousStatus", Order.Status.class);
